...
@Configuration
@EnableJpaAuditing
@EntityScan("com.switchwon.payment.domain")
@EnableJpaRepositories(basePackages = "com.switchwon.payment.infrastructure.persistence")
public class DataJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder
                ...
                .packages("com.switchwon.payment.domain")
                .build();
    }
